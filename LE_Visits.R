...
marcoms <- c('Affiliates_L','Search_L','Search_U',
             'Mobile_Marketing') # 'Online_Affiliates_U', ,'Social_Media''Workshops', 'TV_Marketing',,'Others'

pricing <- c('Price_Online') # ,'Margin_Online'

model_vars <- c('Fiscal_Week','Visits',pricing, marcoms,flags)
model_vars
